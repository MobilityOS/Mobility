 ...
 */
typedef enum _MO_RUNTIME_X64_SEGMENT_TYPE
{
    MO_RUNTIME_X64_SEGMENT_NULL = 0x00,
    MO_RUNTIME_X64_SEGMENT_KERNEL_CODE = 0x08,
    MO_RUNTIME_X64_SEGMENT_KERNEL_DATA = 0x10,
    MO_RUNTIME_X64_SEGMENT_USER_CODE = 0x18,
    MO_RUNTIME_X64_SEGMENT_USER_DATA = 0x20,
    MO_RUNTIME_X64_SEGMENT_TSS = 0x28,
} MO_RUNTIME_X64_SEGMENT_TYPE, *PMO_RUNTIME_X64_SEGMENT_TYPE;

/**
 * @brief The GDT descriptors for x64 architecture.
 */
typedef struct _MO_RUNTIME_X64_GDT_DESCRIPTORS
{
    MO_RUNTIME_X64_SEGMENT_DESCRIPTOR Null;
    MO_RUNTIME_X64_SEGMENT_DESCRIPTOR KernelCode;
    MO_RUNTIME_X64_SEGMENT_DESCRIPTOR KernelData;
    MO_RUNTIME_X64_SEGMENT_DESCRIPTOR UserCode;
...
#endif // !MO_RUNTIME_X64_PAGE_SIZE

#ifndef MO_RUNTIME_X64_ALIGNED_WITH_PAGE
#define MO_RUNTIME_X64_ALIGNED_WITH_PAGE \
    MO_DECLSPEC_ALIGN(MO_RUNTIME_X64_PAGE_SIZE)
#endif // !MO_RUNTIME_X64_ALIGNED_WITH_PAGE

/**
 * @brief The platform-specific context for x64 architecture.
 */
typedef struct MO_RUNTIME_X64_ALIGNED_WITH_PAGE _MO_RUNTIME_X64_PLATFORM_CONTEXT
{
    MO_RUNTIME_X64_PAGE_DIRECTORY_ENTRY PageMapLevel4Entry[512];

    MO_RUNTIME_X64_PAGE_DIRECTORY_ENTRY PageDirectoryPointerEntry[512];

    MO_RUNTIME_X64_PAGE_TABLE_ENTRY PageTableEntry[512 * 4];

    MO_UINT8 KernelStack[MO_RUNTIME_X64_PAGE_SIZE * 6];

    MO_RUNTIME_X64_IDT_GATE_DESCRIPTOR InterruptDescriptorTable[256];

    MO_RUNTIME_X64_GDT_DESCRIPTORS GlobalDescriptorTable;
    MO_RUNTIME_X64_TASK_STATE_SEGMENT TaskStateSegment;
...
} MO_RUNTIME_X64_PLATFORM_CONTEXT, *PMO_RUNTIME_X64_PLATFORM_CONTEXT;
